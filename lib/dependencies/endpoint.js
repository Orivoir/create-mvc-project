...
module.exports = function({
    ...
    dependencies.forEach( package => {
        ...
        if(
            ...
            !paramsInstall.isMySQL &&
            ( package.name === "parse-database-url" ||
            package.name === "mysqldump" ||
            package.name === "mysql-import" )
        ) {

            console.log(
                colorLog.yellow.bold(
                    '\ninstall parse-database-url dependence have been skipped\n'
                )
            ) ;
